...
export default <VdoingThemeConfig>{
    ...
    repo: 'su-dd/blogwriter', // 导航栏右侧生成Github链接
    ...
    bodyBgImg: [
        //   'https://cdn.addai.cn/博客/网站使用/bg2.jpg',
    ...
    indexImg: {
        ...
        desc: ["我不聪明，但是没有关系 —— 来自 Dai Dai", "故事由我书写，旅程由你见证，传奇由她聆听 —— 来自 Young Kbt"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFade 为 true 生效
    ...
    author: {
        name: 'su-dd', // 必需
        link: 'https://github.com/su-dd', // 可选的
    },
    ...
    footer: {
        ...
        copyrightInfo:
            'daidai | <a href="https://beian.miit.gov.cn/" target="_blank">皖ICP备2023000523号-1</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
