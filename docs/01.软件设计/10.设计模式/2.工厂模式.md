...
![工厂模式-流水线](https://cdn.jsdelivr.net/gh/su-dd/cdn@main/博客/知识总结/设计模式/工厂模式-流水线.webp)
...
![工厂模式-类图](https://cdn.jsdelivr.net/gh/su-dd/cdn@main/博客/知识总结/设计模式/工厂模式-类图.webp)
