...
![真爱只有一个](https://cdn.jsdelivr.net/gh/su-dd/cdn@main/博客/知识总结/设计模式/真爱只有一个.webp)

## 实现

类图：

![单例模式](https://cdn.jsdelivr.net/gh/su-dd/cdn@main/博客/知识总结/设计模式/单例模式.webp)
...
https://github.com/su-dd/Demo_DesignPattern/tree/main/Singleton
