...
![内存分配](https://cdn.addai.cn/blog/202304092008990.png)
...
**结果解析：**
首先我们先来看一下这个图，是内存管理机制里面的栈，可以看到main函数中定义的变量`serven_9` ~ `serven_11`分别入栈，而且入栈的顺序是从高地址到低地址，每个变量占用4个字节，所以地址相差也就是4个字节
...
![栈地址](https://cdn.addai.cn/blog/202304100100360.png)
