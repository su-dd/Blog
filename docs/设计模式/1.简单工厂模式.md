...
![冰淇淋自动贩卖机](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/知识总结/设计模式/简单工厂-贩卖机.webp)
...
![简单工厂](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/知识总结/设计模式/简单工厂-类图.webp
)
...
https://github.com/su-dd/demo/tree/main/设计模式/SimpleFactory
