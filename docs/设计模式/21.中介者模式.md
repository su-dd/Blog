...
![部门沟通](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/202208312025837.png)
...
![ERP系统](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/202208312114522.png)

## 实现

![中介者模式](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/知识总结/设计模式/中介者模式.drawio.png)
...
```
**结果：**
![结果](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/202209021937894.png)
...
及时将网状关系的复杂性，收容到一个类中；以使得其他类变得简单。
