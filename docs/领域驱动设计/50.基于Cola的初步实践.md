...
![3层结构的问题](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/2022/5/24/3层结构的问题.png)
...
![分层架构](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/知识总结/架构设计/DDD/分层架构.webp)
...
![cola分包](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/知识总结/架构设计/DDD/Cola/cola分包.webp)
...
![用户接口层和应用层](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/2022/5/24/202205241527906.png)

2、**领域层**的填充

![领域层](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/2022/5/24/202205241541179.png)

3、**基础设施层** 的填充

![基础设施层](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/2022/5/24/202205241547168.png)

## 2、解决DTO臃肿问题

当前的DTO运行方式为：

![传统的读写](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/知识总结/架构设计/DDD/传统的读写.webp)
...
![CQRS读写](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/知识总结/架构设计/DDD/CQRS读写.webp)

Command端与Query端都通过Application Service 进入系统，共享同一个数据库，但Command端只写入状态，Query端只读取状态。

**代码分包方式：**

![CDQS](https://cdn.jsdelivr.net/gh/su-dd/cdn/博客/2022/5/25/202205251257068.png)
